#!/usr/bin/env python3
"""
Recupero codici sconto Arcaplanet da shopilo.it
Sursa: https://shopilo.it/negozi/arcaplanet.it
"""
...
SHOPILO_URL = "https://shopilo.it/negozi/arcaplanet.it"
STORE_NAME = "Arcaplanet"


def fetch_coupons(url=SHOPILO_URL):
    """Restituisce la lista dei coupon attivi per Arcaplanet da shopilo.it"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-it/codice-sconto-arcaplanet)"
    }
    try:
